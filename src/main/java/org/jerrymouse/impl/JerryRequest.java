...
@AllArgsConstructor
@Builder
public class JerryRequest implements HttpServletRequest {

    @Setter private String method;
    @Setter private String uri;
    @Setter private String queryString;
    ...
    public Enumeration<String> getHeaderNames() {
        if (headers == null) return Collections.enumeration(Collections.emptyList());
